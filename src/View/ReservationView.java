...
public class ReservationView extends JFrame {
	...
	public ReservationView() {
		...
		lblNewLabel.setBounds(90, 55, 109, 14);
		contentPane.add(lblNewLabel);
		
		
		//textField = new JTextField();
		textField.setBounds(220, 55, 86, 20);
	...
	/* 	JLabel lblNewLabel_2 = new JLabel("New label");
		...
		lblNewLabel_1.setBounds(90, 160, 124, 14);
		contentPane.add(lblNewLabel_1);
		
		
		// textField_1 = new JTextField();
		textField_1.setBounds(220, 159, 86, 20);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		
		/* bouton pou reserver*/
		JButton btnNewButton = new JButton("Réserver ou refuser");
		btnNewButton.setBounds(125, 95, 160, 23);
	...
	/*  	JButton btnNewButton_1 = new JButton("Décliner");
		...
		btnNewButton_2.setBounds(165, 200, 89, 23);
